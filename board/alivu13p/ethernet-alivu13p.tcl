...
# upper QSFP28 slot uses QUAD 233(contains 4 channels: X1Y52~X1Y55)
# FIXME: TX/RX_REFCLK_SOURCE (`MGTREFCLK0 233`) and FREERUN_FREQUENCY?
set_property -dict [list \
    CONFIG.CHANNEL_ENABLE {X1Y55} \
    CONFIG.TX_MASTER_CHANNEL {X1Y55} \
    CONFIG.RX_MASTER_CHANNEL {X1Y55} \
    ...
    CONFIG.RX_REFCLK_SOURCE {X1Y55 clk1} \
    CONFIG.TX_REFCLK_SOURCE {X1Y55 clk1} \
